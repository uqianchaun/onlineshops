...
<script>
     function judgepay()
     {
    	 var str1= document.getElementsByName("error3")[0].value;
    	 if(str1!=null)
    		 alert("余额不足,请充值");
     }
</script>
</head>
<body onload="javascript:judgepay()">
	<!--header-->
	<div class="header">
				...
				<div class="logo-nav">
					...
					<div class="logo-nav-right">
						...
						<div id="cd-search" class="cd-search">
							<form action="<%=pageContext.getServletContext().getContextPath()%>/goods/queryLikesGoods.action" method="post">
								<input name="gname" type="search" placeholder="Search...">
							</form>
						</div>
					</div>
					<div class="header-right2">
						<div class="cart box_1">
							...
							<p>
								<a href="<%=pageContext.getServletContext().getContextPath()%>/car/deleteAll.action" class="simpleCart_empty">清空购物车</a>
							</p>
							<div class="clearfix"></div>
						</div>
					</div>
	...
	<div class="content">
		<div class="cart-items">
			<div class="container">
				<h2>我的购物车</h2>
                <h3><font color="red">${error4 }</font></h3>
                <h3><font color="red">${numbererror }</font></h3>
                <h3><font color="red">${locationerror }</font></h3>
                <center><h3><font  style="font-weight: bolder;"color="green">${open }</font></h3></center>
				<c:forEach items="${cars}" var="c" varStatus="s">
				...
				<!-- <script>
					...
					<div class="cart-header">
						...
						<div class="cart-sec simpleCart_shelfItem">
							<div class="cart-item cyc">
								<a href="<%=pageContext.getServletContext().getContextPath()%>/goods/queryGoodsById.action?gid=${c.goods.gid}"><img src="/image/${c.goods.gpicture }" class="img-responsive img-thumbnail" alt=""></a>
							</div>
							<div class="cart-item-info">
								<ul class="delivery">
								<h1><a href="<%=pageContext.getServletContext().getContextPath()%>/goods/queryGoodsById.action?gid=${c.goods.gid}"> ${c.goods.gname }</a>  </h1><span><a href="<%=pageContext.getServletContext().getContextPath()%>/car/deleteCar.action?float_number=${c.float_number }"><img
									src="<%=pageContext.getServletContext().getContextPath()%>/images/close_1.png"
									/></a></span>
								</ul>
								...
								<div class="delivery">
									<p></p>
									<span><font size="5">总价:&nbsp;&nbsp;${c.g_number*c.goods.gmoney }</font></span>
									<div class="clearfix"></div>
								</div>
							</div>
							<div class="clearfix"></div>
					...
					<form action="<%=pageContext.getServletContext().getContextPath() %>/order/insertOrdering.action" name="charput" method="post">		
									<div class="clearfix"></div>
						
							<div class="col-md-offset-10">
              				<input  class="btn btn-info btn-lg btn-block" type="submit" value="提交订单">
             				 </div>
					</form>
			</div>
		</div>
