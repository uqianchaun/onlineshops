...
<!--主体内容-->
    <section class="publicMian ">
        ...
        <div class="right">
	    <form action="<%=pageContext.getServletContext().getContextPath() %>/goods/queryGoods.action" method="post" name="myform">
	     <br/>
	        <br/>
	         <br/>
	          <br/>
	           <br/>
	        <center> <font size="6" class="ziti">操作失败</font></center>
	        <br/>
	        <br/>
	         <br/>
	          <br/> <br/>
			  <center><input type="submit" value="返回上一步"/></center>
		</form>
        </div>
    </section>
    <footer class="footer">
