...
<!-- 										</li> -->
							...
							<div class="single-right simpleCart_shelfItem">
								<form action="<%=pageContext.getServletContext().getContextPath() %>/car/addCar.action" name="gouwu" method="post">
									<h4>${goods.gname }</h4>
									<div class="block">
								...
								<div class="bs-example bs-example-tabs" role="tabpanel"
									...
									<ul id="myTab" class="nav nav-tabs left-tab" role="tablist">
										<li role="presentation" class="active"><a href="#home"
											...
											aria-controls="home" aria-expanded="true">商品描述</a></li>
										<li role="presentation"><a href="#reviews" role="tab"
											id="reviews-tab" data-toggle="tab" aria-controls="reviews">精选评论
												</a></li>
										...
										<div role="tabpanel" class="tab-pane fade in active" id="home"
											...
											<div class="descr">
												...
												<table border="1">
													...
													<c:forEach items="${pictures }" var="ps" varStatus="s">
													 <c:if test="${(s.count-1) % 1 eq 0 || (s.count-1) eq 1}">   
												      <tr>   
												      </c:if>
																			
															<td><img src="/image/${ps.ppicture }" /></td>
										...
										<div role="tabpanel" class="tab-pane fade" id="reviews"
											...
											<div class="descr">
												<div class="reviews-top">
													...
													<table >
												     <c:forEach items="${reviews}" var="rs" varStatus="s">
													<div class="reviews-right">
														<ul>
															<li><a href="#">${rs.client_rename}</a></li>
															<li><a href="#"><i
																	class="glyphicon glyphicon-share" aria-hidden="true"></i>回复</a>
															</li>
														</ul>
														<p>${rs.reviews }</p>
													</div>
