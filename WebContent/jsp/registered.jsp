...
<!--header-->
		...
		<div class="banner1">
			<div class="container">
				<h3><a href="<%=pageContext.getServletContext().getContextPath() %>/jsp/index.jsp">主界面</a> / <span>注册</span></h3>
			</div>
		</div>
		<!--banner-->
			...
			<div class="login">
				<div class="main-agileits">
					<div class="form-w3agile form1">
						...
						<form action="<%=pageContext.getServletContext().getContextPath() %>/judge/registered.action" name="add" method="post">
							<font  style="font-weight: bolder;"color="red">${error }</font>
							<div class="key">
								<i class="fa fa-user" aria-hidden="true"></i>
								<input type="text" name="login_id" placeholder="手机号/邮箱" required="required">
								<div class="clearfix"></div>
							</div>
							<div class="key">
								<i class="fa fa-user" aria-hidden="true"></i>
								<input type="text" name="client_rename" placeholder="昵称" required="required">
								<div class="clearfix"></div>
							</div>
							<div class="key">
							...
							<input class="center-block" type="button" onclick="checkzhuce()" value="注册">
						</form>
					</div>
