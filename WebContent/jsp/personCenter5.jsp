...
<title>PersonCenter</title>
		...
		<script src="<%=pageContext.getServletContext().getContextPath()%>/js/checkwrong.js"></script>
		<!-- cart -->
</head>
<body >
<!--header-->
		...
		<div class="banner1">
			<div class="container">
				<h3><a href="<%=pageContext.getServletContext().getContextPath() %>/jsp/index.jsp">主界面</a> / <span>更改密码</span></h3>
			</div>
		</div>
		<!--banner-->
			...
			<div class="form-w3agile">
				...
				<div class="button">
					...
					<a
						...
						<div class="right1">
							<form action="<%=pageContext.getServletContext().getContextPath() %>/user/updateUser.action?sign=1" name="att" method="post">
								
								<label style="border-color: #03A9F4; width: 300px;"><font size="5">当前密码<font color="red">*</font></font>
								</br><font color="red">${error1 }</font> 
								<input type="password" class="form-control" name="login_password2" placeholder="请填入密码" required="required">
								<div class="clearfix"></div></label><input type="hidden" name="login_password3" value="${error1 }">
								
								
								<label style="border-color: #03A9F4; width: 300px;"><font size="5">更改密码<font color="red">*</font></font>
								<div id="showError"></div>
								<input type="password" class="form-control" name="login_password" placeholder="请填入密码" required="required">
								<div class="clearfix"></div></label>

								<label style="border-color: #03A9F4; width: 300px;"><font size="5">确认更改密码<font color="red">*</font></font>
									<br /><div id="showError"></div>
									<input type="password" class="form-control" name="Confirm_Password" placeholder="请填入密码" required="required">
								<div class="clearfix"></div></label>

								</br>
								</br>
								<label style="border-color: #03A9F4;width: 300px;"><input type="button" onclick="checkou1()" width="500px" class="center-block" value="提交" /></label>
							</form>
						</div>
					</section>
				</div>
