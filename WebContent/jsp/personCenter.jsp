...
<script
	src="<%=pageContext.getServletContext().getContextPath() %>/js/jquery-1.11.3.min.js"></script>
<script
	src="<%=pageContext.getServletContext().getContextPath() %>/js/Popt.js"></script>
<script
	src="<%=pageContext.getServletContext().getContextPath() %>/js/cityJson.js"></script>
<script
	src="<%=pageContext.getServletContext().getContextPath() %>/js/citySet.js"></script>
...
html, body, h1, h2, h3, h4, h5, h6, div, ul, ol, li, dl, dt, dd, iframe,
	textarea, input, button, p, strong, b, i, a, span, del, pre, table, tr,
	th, td, form, fieldset, .pr, .pc {
	margin: 0;
	padding: 0;
	word-wrap: break-word;
...
<body onload=" sex('${user.client_sex }');">
	...
	<div class="header">
		<div class="header-top">
			<div class="container">
				<div class="top-left">
					<font size="3"> <a href="<%=pageContext.getServletContext().getContextPath() %>/jsp/mailus.jsp">联系我们 <i
							class="glyphicon glyphicon-phone" aria-hidden="true"></i>
							199-1762-9837
					</a>
				</div>
				<div class="top-right">
	...
	<div class="banner1">
		<div class="container">
			<font size="2">
				<h3>
					<a href="<%=pageContext.getServletContext().getContextPath()%>/jsp/index.jsp">主界面</a> / <span>完善信息</span>
				</h3>
			</font>
		</div>
	</div>
	...
	<div class="main-agileitsc">
		 ...
		 <div class="form-w3agile">
				...
				<div class="right3">
					<form
						action="<%=pageContext.getServletContext().getContextPath() %>/user/updateUser.action?sign=2"
						name="dff" method="post">

						<label style="border-color: #03A9F4; width: 300px;"><font
							size="5">真实姓名<font color="red">*</font></font> <input type="text"
							class="form-control" name="client_name"
							value="${user.client_name }" placeholder="请填入真实姓名"
							required="required">
							<div class="clearfix"></div></label>
							 <label style="border-color: #03A9F4; width: 300px;">
							 <font size="5">出生日期<font color="red">*</font></font> 
							 <input type="date" value="${user.client_age }" class="form-control"
							 name="client_age" />
							<div class="clearfix"></div> 
							<label style="border-color: #03A9F4; width: 300px;">
							<font size="5">用户性别<font color="red">*</font></font></br>
								 <input type="radio" name="client_sex" value="男" /><font size="3">男</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="client_sex" value="女" /><font
								size="3">女</font>
								<div class="clearfix"></div></label>
								 <script>
						...
						</script> <label style="border-color: #03A9F4; width: 300px;"><font
								size="5">联系方式<font color="red">*</font></font> <br />
								<div id="showError"></div> <input type="text"
								class="form-control" name="client_tel"
								value="${user.client_tel }" placeholder="请填入联系方式"
								required="required">
								<div class="clearfix"></div></label> <label
							style="border-color: #03A9F4; width: 300px;"><font
								size="5">用户地址<font color="red">*</font></font> <input
								type="text" class="form-control" id="city"
								value="${user.client_address }" name="client_address">
								<script type="text/javascript">
										$("#city").click(function (e) {
											SelCity(this,e);
										});
										</script>
								<div class="clearfix"></div></label> </br> </br> <!--<label style="border-color: #03A9F4;width: 300px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="#"><font class="tu" size="7">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提交&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></a>-->
							<label style="border-color: #03A9F4; width: 300px;"><input
								type="button" onclick="checktel()" width="500px"
								class="center-block" value="提交" /></label>
					</form>
				</div>
				</section>
 			</div> 
	...
	<script
		src="<%=pageContext.getServletContext().getContextPath() %>/js/checkzhuce.js"></script>
	<!--copy-->
	<!--copy-->
</body>
</html>